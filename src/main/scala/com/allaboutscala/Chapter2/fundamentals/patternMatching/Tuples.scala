package com.allaboutscala.Chapter2.fundamentals.patternMatching
...
object Tuples extends App {
  ...
  val strawberryDonut = Tuple3("Strawberry Donut", "Fruity", 2.77)
  ...
  val priceOfPlainDonut = donutList.foreach { tuple => {
      tuple match {
        ...
        case d if d._1 == "Strawberry Donut" => println(s"Donut type = ${d._1}, taste level = ${d._2}, price = ${d._3}")
        case _ => None
      }
    }
  }
